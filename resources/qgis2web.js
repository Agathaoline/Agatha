...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA IBUKOTA PROVINSI DAN KABUPATEN</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (81 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menyajikan Batas Wilayah Provinsi Kalimantan Selatan dan Batas Kabupaten';
            }
